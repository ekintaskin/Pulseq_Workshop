...
sys = mr.opts('MaxGrad', 22, 'GradUnit', 'mT/m', ...
    'MaxSlew', 55, 'SlewUnit', 'T/m/s', 'rfRingdownTime', 20e-6, ...
    'rfDeadTime', 100e-6, 'adcDeadTime', 10e-6);

seq=mr.Sequence(sys);         % Create a new sequence object

fov=225e-3; Nx=256; Ny=Nx; % Define FOV and resolution
alpha=10;                  % flip angle
...
%TE=[3.45 4.6 5.75 6.9 8.05 9.2]*1e-3;
TE=[4.6 5.75 6.9 8.05 9.2 10.35]*1e-3;
% more in-depth parameters
rfSpoilingInc=117;              % RF spoiling increment
roDuration=Nx*sys.gradRasterTime;              % ADC duration
...
gxPre = mr.makeTrapezoid('x','Area',-gx.area/2,'Duration',1.5e-3,'system',sys);
...
seq.write('/Users/ekintaskin/Downloads/Pulseq_Workshop-main/P4_Multiecho_sequence/gre_lbl_256.seq')       % Write to pulseq file
