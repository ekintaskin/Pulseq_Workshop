...
TE=[4.6 10.35 16.1 21.85 26.25 31.05]*1e-3;
...
seq.write('/Users/ekintaskin/Downloads/Pulseq_Workshop-main/P4_Multiecho_sequence/bgre.seq')       % Write to pulseq file
%seq.install('siemens');
